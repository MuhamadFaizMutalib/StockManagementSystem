...
void Menu::Welcome()
{
    ...
    cout << endl << endl;
    cout << "\t\t\t\t WELCOME to Phonebook Menu System."<< endl; 
    cout << " ====================================================================================================== " << endl; 
    cout << "\n Features : \n";
    cout << " * Add new contact, show all contacts, delete contact, search contact and exit menu.\n";
    cout << " * View all contacts.\n"; 
...
void Menu::Ending() // show members involve in this programming technique project
{
	...
	cout << "\n\n\n\t\t\t\t";
	cout << "Leader: Muhamad Faiz Bin Abdul Mutalib    (A21EC0059)"<<endl;
	cout << "\t\t\t\t";
	cout << "Muhammad Danial Wajdi Bin Safiay  (A21EC0071)"<<endl;
	cout << "\t\t\t\t";
	cout << "MUHAMMAD AFIQ AZMI BIN SUHAIZI    (A21EC0063)"<<endl;
	cout << "\n\n\n\n\n\n\n\n\n\n";
